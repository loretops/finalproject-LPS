...
```
Aecrca de estos pasos, tengo dudas:


1. Como puedo Configurar despliegue automático para que cada push a la rama principal actualice tu aplicación?
2. Cómo puedo trabajar con cursor y la app en la nube?
3. Cuales son las limitaciones de numero de despliegues y tiempo de construccion de vercel?
```
